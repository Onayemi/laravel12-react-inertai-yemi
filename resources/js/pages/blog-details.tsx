                ...
                <section className="px-10 py-20 lg:px-20">
                    <div className="container">
                        <div className="relative flex flex-col justify-between gap-10 lg:flex-row">
                            ...
                            <aside className="top-10 h-fit flex-shrink-0 lg:sticky lg:w-[250px] xl:w-[300px]">
                                <Link className="mb-5 flex items-center gap-1 text-muted-foreground hover:text-primary" href={route('blog')}>
