...
export default function FooterSection() {
    return (
        <footer className="border-b bg-gray-100 pt-20 dark:bg-transparent">
                        ...
                        {links.map((link, index) => (
                            <div key={index} className="space-y-4 text-sm">
                                ...
                                {link.items.map((item, index) => (
                                    <Link key={index} href={item.href} className="block text-muted-foreground duration-150 hover:text-primary">
